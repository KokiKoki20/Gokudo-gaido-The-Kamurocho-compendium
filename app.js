    ...
    characters: {
      "Ichiban Kasuga": {
        ...
        substories:  [
        {
          ...
          reward: "Playlist App access",
          requirements: "Unmissable, during main story",
          guide: [
            "1. Automatic during main story after getting sake idea",
            "2. Complete the relatively low-key fight",
            "3. Unlocks Playlist App for music on the go",
            "4. Hold L1/LB + D-Pad to play music"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 2,
          chapter: 2,
          name: "Sujimon, Generation II",
          location: "Street level after backpack scene",
          reward: "Sujidex App restored",
          requirements: "Unmissable, during main story",
          guide: [
            "1. Automatic after Ichiban gets backpack",
            "2. Low-stakes fight",
            "3. Sujimon Sensei reappears",
            "4. Restores Sujidex App (doesn't backfill previous encounters)"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          chapter: 3,
          name: "Crazy Money",
          location: "Unlocks later in Chapter 3",
          reward: "$30, Charlie as Poundmate",
          requirements: "Unmissable, unlocks Crazy Delivery minigame",
          guide: [
            "1. Unlocks automatically later in Chapter 3",
            "2. Cannot be missed",
            "3. Unlocks Crazy Delivery minigame",
            "4. Adds Charlie to Poundmates"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          name: "Busted!",
          location: "Unlocks later in Chapter 3",
          reward: "Poundmates feature enabled",
          requirements: "Unmissable",
          guide: [
            "1. Unlocks automatically later in Chapter 3",
            "2. Cannot be missed",
            "3. Enables Poundmates feature"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 5,
          chapter: 3,
          name: "Welcome to Hawaii, MFer!",
          location: "Outside Revolve Bar",
          reward: "Aloha Links App",
          requirements: "Unmissable after first night at Revolve Bar",
          guide: [
            "1. Automatic after leaving Revolve Bar",
            "2. Encounter Kei",
            "3. Get Aloha Links App",
            "4. Bartender and Kei added to app automatically"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 6,
          chapter: 3,
          name: "Surfin' the Streets!",
          location: "Outside Pigeon Family Market on Aloha St.",
          reward: "Street Surfer access",
          requirements: "None",
          guide: [
            "1. Approach Oka-san outside Pigeon Family Market",
            "2. Learn about new transportation method",
            "3. Ride down street as indicated",
            "4. Beat up thugs at the end"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          chapter: 3,
          name: "Miss Match",
          location: "Triangular park south of Revolve Bar",
          reward: "Miss Match minigame access",
          requirements: "None",
          guide: [
            "1. Approach dolphin statue in park",
            "2. Introduced to Miss Match minigame",
            "3. Complete first encounter",
            "4. Can replay at Cream & Berry anytime"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 8,
          chapter: 3,
          name: "Snap Those Sickos!",
          location: "Aloha Beach Trolley Station",
          reward: "Rejuvenation Bolus",
          requirements: "None",
          guide: [
            "1. Board trolley at Aloha Beach Station",
            "2. Substory begins automatically",
            "3. Unlocks Sicko Snap minigame",
            "4. Complete the run for reward"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 9,
          chapter: 3,
          name: "A Love as Sweet as Lemons",
          location: "East Waikiki, north of ABC Store",
          reward: "Hawaiian Pizza, Hand-Mixed Fruit Cup, $100",
          requirements: "None",
          guide: [
            "1. Approach lemonade stand",
            "2. Buy lemonade, learn about Tony",
            "3. Hand out 4 free samples in 2 minutes:",
            " • Don't bump into people or cars",
            " • Look for blue dots on minimap",
            " • Check text balloons for interest",
            "4. Complete subsequent runs (6 cups, then 8 cups)",
            "5. Fight Tony's Uncle (Level check recommended)",
            "6. Final scene west of Morning Joe's"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 10,
          chapter: 3,
          name: "Coming Out of Her Shell",
          location: "Aloha Beach southeast of Taxi Stop",
          reward: "Jeweled Shell, Nancy & Olivia Poundmates",
          requirements: "Poundmates access required",
          guide: [
            "1. Find marker near Swimwear Changeroom",
            "2. Nancy interacts with hermit crab",
            "3. Take taxi away and return",
            "4. Get flowers from northwest Little Japan",
            "5. Use 'Normal Throw' for accuracy",
            "6. Defeat 3 Level 10 treasure seekers"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          chapter: 3,
          name: "Wait for Me",
          location: "Northwest Little Japan, Sakura & Momo St.",
          reward: "Employee Meal, The Epicurean's Epithet, $300",
          requirements: "None",
          guide: [
            "1. Find chef needing waiter",
            "2. Greet customers with correct tones:",
            " • First lady: 'Friendly'",
            " • Gentleman: 'Refined'",
            " • Family: 'Friendly'",
            "3. Take orders:",
            " • Cheerful: One ahi poke, three haupias",
            " • Elegant: Mahi mahi",
            " • Black clothes: Açaí bowl and lau lau",
            "4. Identify dishes: lau lau (left), kālua pig (center)",
            "5. Remember chef name: 'Obispo'"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 12,
          chapter: 3,
          name: "Saved by Kindness",
          location: "East end of Waikiki St.",
          reward: "Happy Lei",
          requirements: "None",
          guide: [
            "1. Find Sawai on ground",
            "2. Help find his hotel",
            "3. Return to marked spot multiple times",
            "4. Correct answer: 'The lei girl?'",
            "5. Follow pair to park",
            "6. Defeat 4 Level 10 bad guys"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          chapter: 3,
          name: "Rock and Roil",
          location: "Aloha Beach near Juicery",
          reward: "Def Boom Box, Kazami Evolution Poundmate",
          requirements: "Poundmates access required",
          guide: [
            "1. Find man being fanned near Juicery",
            "2. Go to Mehalona Mall for wind shaman",
            "3. 'Ask spirits for storm'",
            "4. Return to Kazami",
            "5. Perform summoning movements (lenient timing)",
            "6. Complete ritual"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 14,
          chapter: 3,
          name: "Neck-Deep in Love",
          location: "West beach near Soleil",
          reward: "Courage Pendant",
          requirements: "None",
          guide: [
            "1. Find girl in school uniform behind surfboard",
            "2. Remember details: Tanabe-kun, cropped hair, glasses",
            "3. Speak to all four kids with text balloons",
            "4. Correct location: second row front, second column left",
            "5. Deliver letter"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 15,
          chapter: 3,
          name: "Samurai, May We Walk Together?",
          location: "East from Crystal Aloha Resort",
          reward: "Bright Yellow Sweets, Nathan Poundmate",
          requirements: "Poundmates access required",
          guide: [
            "1. Find marker on beach (dangerous area)",
            "2. Defeat 2 Level 9 pick-up artists",
            "3. Interview with Nathan:",
            " • Choose Japanese responses",
            " • Rice and millet",
            " • The hat",
            "4. Defeat 4 Level 9 guys"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 16,
          chapter: 3,
          name: "Beach Guardian: Water, Water Everywhere",
          location: "Middle of Aloha Beach water",
          reward: "Resurrection Bolus",
          requirements: "None",
          guide: [
            "1. Find struggling swimmer in water",
            "2. Help Raymond with lifeguard duty",
            "3. Deliver 10 water bottles in 3 minutes",
            "4. All potential people marked on minimap",
            "5. No penalty for wrong interactions",
            "6. Look for thirst/blurred vision dialogue"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 17,
          chapter: 3,
          name: "Beach Guardian: No Kidding Around",
          location: "Lifeguard station",
          reward: "Heartful Golem",
          requirements: "Complete #16",
          guide: [
            "1. Return to lifeguard station after #16",
            "2. Deal with troublemakers",
            "3. Find missing girl Emmy:",
            " • Red swimsuit, straw hat with blue ribbon",
            " • East side of beach near palm tree",
            "4. Find boy Billy:",
            " • White trunks, orange cap",
            " • Far west on beach playing in sand"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 18,
          chapter: 3,
          name: "Beach Guardian: Heroes of the Sand",
          location: "Lifeguard station",
          reward: "Infrared Goggles",
          requirements: "Complete #17",
          guide: [
            "1. Return to lifeguard station after #17",
            "2. Catch thief on beach chase",
            "3. Follow QTEs",
            "4. Go to Kana's Coconut Juice Stand",
            "5. Defeat 7 Level 10 enemies"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          chapter: 3,
          name: "Home to Roost",
          location: "Southeast of Crystal Aloha Resort",
          reward: "Periodic fruits/plants from Joseph",
          requirements: "Poundmates access required",
          guide: [
            "1. Find beach chair marker (dangerous area)",
            "2. Rest on chair, meet new friend",
            "3. Navigate to ABC Store avoiding sumo wrestlers",
            "4. Go north near Kana's Stand, avoid people/cars",
            "5. Defeat 2 Level 9 poachers",
            "6. Visit Joseph on Revolve balcony periodically"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          chapter: 4,
          name: "A Better Bat",
          location: "Beginning of Chapter 4",
          reward: "Equipment upgrading unlocked",
          requirements: "Unmissable",
          guide: [
            "1. First thing in Chapter 4",
            "2. Cannot be missed",
            "3. Unlocks equipment upgrading system"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          location: "Harbor St. west of Anaconda Center",
          reward: "Ounabara Vocational School access",
          requirements: "None",
          guide: [
            "1. Approach fire dancers crowd",
            "2. Unlocks Ounabara Vocational School",
            "3. First exam free"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          chapter: 4,
          name: "Rise and Grind",
          location: "West of Diamond Head on Anaconda Blvd.",
          reward: "$270, Mameoka Poundmate",
          requirements: "None",
          guide: [
            "1. Approach Cafe Soramame crowd",
            "2. Defeat 2 Level 13 thugs",
            "3. Return to find graffiti",
            "4. Go to Twilight St. in Cultural District",
            "5. Find Fumita in alley",
            "6. Defeat 4 Level 19 guys",
            "7. Answer 'Sorata' for Personality boost"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 23,
          chapter: 4,
          name: "The More, the Plumeria",
          location: "Sunset Park gazebo",
          reward: "Pareo of Happiness",
          requirements: "None",
          guide: [
            "1. Approach flowering tree at gazebo",
            "2. Find second tree at Harbor Park",
            "3. Listen to couple south of Momo St.",
            "4. Follow to marker east",
            "5. Help find blue plumerias",
            "6. Defeat 2 Level 17 Sumo Wrestlers",
            "7. Gather blue flowers at Sunset Park",
            "8. Find Aina at Art Walls (dangerous area)"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          chapter: 4,
          name: "Let It Snow",
          location: "Mohala Shave Ice",
          reward: "Patriarch Gondawara Poundmate",
          requirements: "None",
          guide: [
            "1. Witness snow attempt at Mohala",
            "2. Go to marker on Momo St. north",
            "3. Head to Anaconda Shopping Center first floor",
            "4. Chase baby carriage sequence",
            "5. Defeat 3 Level 17 enemies",
            "6. Final marker across from Kiryu's Hotel"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 25,
          chapter: 4,
          name: "Embrace Your Wild Side",
          location: "Anaconda Shopping Center second floor",
          reward: "Signed Golem T-Shirt",
          requirements: "None",
          guide: [
            "1. Approach ukelele player in atrium",
            "2. Meet Matt Tropico",
            "3. Go to northwest WW Market Village",
            "4. Return to Anaconda Center",
            "5. Defeat 3 Level 12 enemies",
            "6. Go to south Aloha Bridge area",
            "7. Find kid and mom northeast corner",
            "8. Visit Treasure Select Pawn in Chinatown",
            "9. Final scene at Aloha Beach Juicery"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          location: "Anaconda Shopping Center second floor",
          reward: "Silver Plates, Safe Key (perfect run)",
          requirements: "SAVE BEFORE STARTING",
          guide: [
            "1. Approach light blue dressed weirdos",
            "2. 6-minute time limit with enemy interruptions",
            "3. Locations:",
            " • Computer right at start: 'True' (1 point)",
            " • North central computer: 'hat shop' → code 8931",
            " • South central red container: code 8931 (3 points + Divine Water)",
            " • East walkway benches: Blue Key",
            " • South east blue container: (2 points + Ahi Poke Bowl)",
            "4. Win conditions:",
            " • Fail goal: Silver Plate",
            " • Reach goal: Silver Plate + Smoke Bomb",
            " • Perfect (6 points): 2 Silver Plates + Safe Key"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 27,
          chapter: 4,
          name: "The Pursuit of Realism",
          location: "Southeast Anaconda, south of highway",
          reward: "Kaiser's Change Holder, Reflex Booster, Bony Kashiwa Poundmate",
          requirements: "None",
          guide: [
            "1. Defeat 2 Level 12 enemies",
            "2. Meet director Bony Kashiwa",
            "3. Stunt run dodging cars and explosions",
            "4. Use Left Stick to weave",
            "5. Three attempts available",
            "6. Failure damages but allows retry"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 28,
          chapter: 4,
          name: "An Authentic Blockbuster",
          location: "Sunset Park near Makani Coffee",
          reward: "Modified Rocket Launcher",
          requirements: "Complete #15 and #27",
          guide: [
            "1. Find James on bench",
            "2. Call Bony Kashiwa Poundmate",
            "3. More stunt runs with semi trucks",
            "4. Trucks weave slightly",
            "5. Three attempts available"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          chapter: 4,
          name: "Litterbugged",
          location: "Northwest Anaconda near Trolley Stop",
          reward: "Animal Bone Necklace",
          requirements: "None",
          guide: [
            "1. Witness littering couple",
            "2. Meet Professor Okita",
            "3. Invest $3000 (all at once or installments)",
            "4. Wait ~10 minutes for text",
            "5. Go to Harbor Park",
            "6. Trash identification quiz:",
            " • Worn/ratty = trash",
            " • Clean = not trash",
            "7. Defeat SOJIMARU V2.1 (Level 27)",
            " • Main body: Weak to Fire",
            " • Left Module: Weak to Ice",
            " • Right Dispenser: Weak to Electric"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 30,
          chapter: 4,
          name: "Close Encounters of the Bird Kind?",
          location: "North Kaku Ave. West Waikiki",
          reward: "Antique Coin, Hibiscus Hair Band, Poundmate",
          requirements: "Complete #29, must be nighttime",
          guide: [
            "1. Find UFO witness with police officer",
            "2. Locate her in WW Market Village north entrance",
            "3. Return at nighttime (Chapter 5 recommended)",
            "4. Fight SOJIMARU FLYING BETA MAX (Level 29)",
            " • Main target: Weak to Gun/Fire",
            " • Battery Charger: Weak to Ice/Electric (stops healing)"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 31,
          chapter: 5,
          name: "Let's Get Alo-Happy!",
          location: "Automatic in Chapter 5",
          reward: "Job System unlocked",
          requirements: "Unmissable",
          guide: [
            "1. Automatic during Chapter 5",
            "2. Cannot be missed",
            "3. Unlocks Job System"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 32,
          chapter: 5,
          name: "Tropical Photo Rally",
          location: "Automatic in Chapter 5",
          reward: "Tropical Photo Rally unlocked",
          requirements: "Unmissable",
          guide: [
            "1. Automatic during Chapter 5",
            "2. Cannot be missed",
            "3. Unlocks Tropical Photo Rally minigame"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 33,
          chapter: 6,
          name: "The Island at Rock Bottom",
          location: "Automatic in Chapter 6",
          reward: "Dondoko Island unlocked",
          requirements: "Unmissable",
          guide: [
            "1. Automatic during Chapter 6",
            "2. Cannot be missed",
            "3. Begins Dondoko Island saga"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 34,
          chapter: 5,
          name: "Legend of the Labyrinth",
          location: "Automatic in Chapter 5",
          reward: "Hawaiian Haunt dungeon unlocked",
          requirements: "Unmissable",
          guide: [
            "1. Automatic during Chapter 5",
            "2. Cannot be missed",
            "3. Unlocks Hawaiian Haunt dungeon"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 35,
          chapter: 6,
          name: "Love and Punishment",
          location: "Cultural District alley off Night St.",
          reward: "5 Fancy Free Magazines, Platinum Plate",
          requirements: "May need to be nighttime",
          guide: [
            "1. Find crying woman at alley entrance",
            "2. Agree to stay with her",
            "3. Wake up lighter on cash",
            "4. Find her on Pearl St. at nighttime",
            "5. Defeat Level 25 enemy",
            "6. Wait until daytime (Chapter 7)",
            "7. Final scenes at Harbor Park and Bullet Hell",
            "8. Defeat another Level 25 enemy"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 36,
          chapter: 9,
          name: "Relics from the Past",
          location: "Southeast of Crystal Aloha Resort",
          reward: "Gorgeous Rubber Gloves",
          requirements: "None",
          guide: [
            "1. Approach giant red excavators",
            "2. Go east to speak to top hat man",
            "3. Leave area, go to next marker further east",
            "4. Return to excavators for fight",
            "5. Defeat Level 31 excavators:",
            " • Weak to Fire and Ice",
            " • Resistant to Blade and Electric"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 37,
          chapter: 4,
          name: "Choosing Your Starter",
          location: "Anaconda Shopping Center",
          reward: "Sujimon League unlocked",
          requirements: "Unmissable",
          guide: [
            "1. Automatic during Anaconda Shopping Center visit",
            "2. Cannot be missed",
            "3. Unlocks Sujimon League"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 38,
          chapter: 4,
          name: "The CEO of Suji",
          location: "Sujimon Stadium",
          reward: "First gym leader completion",
          requirements: "Sujimon League unlocked",
          guide: [
            "1. Part of Sujimon League",
            "2. First gym leader battle",
            "3. Complete to progress in Sujimon storyline"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 39,
          chapter: 4,
          name: "The Queen's Subilee",
          location: "Sujimon Stadium",
          reward: "Second gym leader completion",
          requirements: "Complete #38",
          guide: [
            "1. Part of Sujimon League",
            "2. Second gym leader battle",
            "3. Complete to progress in Sujimon storyline"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 40,
          chapter: 4,
          name: "A True Gym Battle",
          location: "Sujimon Stadium",
          reward: "Third gym leader completion",
          requirements: "Complete #39",
          guide: [
            "1. Part of Sujimon League",
            "2. Third gym leader battle",
            "3. Complete to progress in Sujimon storyline"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 41,
          chapter: 4,
          name: "Sodachi's Revenge",
          location: "Ace's Dojo",
          reward: "Super Sodachi recruitment",
          requirements: "Midway through Sujimon League progress",
          guide: [
            "1. Get call from Joker at Trainer Rank milestone",
            "2. Go to Ace's Dojo",
            "3. Sodachi leaves your roster",
            "4. Reach Trainer Rank 40",
            "5. Return to Ace's Dojo for Super Sodachi",
            "6. Enables fourth gym leader battle"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 42,
          chapter: 4,
          name: "Atop the Plateau",
          location: "Sujimon Stadium",
          reward: "Championship completion",
          requirements: "Complete #41",
          guide: [
            "1. Championship match against King",
            "2. Available after #41 completion",
            "3. Final Sujimon Stadium battle"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 43,
          chapter: 4,
          name: "A Man Named Asakura",
          location: "West end of Aloha St. near bridge",
          reward: "Merciless Melee skill",
          requirements: "None",
          guide: [
            "1. Find Asakura from Chapter 1",
            "2. Rematch fight (Ichiban alone)",
            "3. Asakura Level 12",
            "4. Learn permanent unique skill"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          chapter: 5,
          name: "A Changed Man",
          location: "Southwest Shipper's Wharf",
          reward: "Heart of a Champion skill",
          requirements: "Complete #43, dangerous area (Level 26+)",
          guide: [
            "1. Asakura texts new location",
            "2. Go to marked spot in Shipper's Wharf",
            "3. Fight Level 26 Asakura",
            "4. Uses Evasion buff mid-fight",
            "5. Use magic attacks recommended"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 45,
          chapter: 5,
          name: "The Final Showdown for Real",
          location: "Shipper's Wharf",
          reward: "Knockout Combo skill",
          requirements: "Complete #44",
          guide: [
            "1. Asakura texts return to wharf",
            "2. Final match against Level 33 Asakura",
            "3. Be prepared for tough fight"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 46,
          chapter: 5,
          name: "A Man Facing the Future",
          location: "Warehouse area",
          reward: "Brawler God's Mouthguard, Asakura Poundmate",
          requirements: "Complete #45",
          guide: [
            "1. Asakura texts warehouse location",
            "2. Fight with Asakura as ally (Ichiban only)",
            "3. Enemies Level 43",
            "4. Two groups of six, then group of three with high HP",
            "5. Keep health up, let Asakura help"
          ].join("\n"),
          videoId: "",
        }
      ],
      ...
      "Kiryu Kazuma": {
        ...
        substories: [
        {
          ...
          location: "Southwest Yokohama",
          reward: "Hamako as Dondoko Guest",
          requirements: "Available after recruiting Saeko",
          guide: [
            "1. Available immediately after Saeko recruitment",
            "2. Conversation-based memoir",
            "3. No combat required",
            "4. Unlocks Hamako as Dondoko Island guest"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 48,
          chapter: 8,
          name: "The Underground Weapons Dealer",
          location: "Near Gambling Hall ladder in Yokohama",
          reward: "Rings of the Master, weapon shop unlocked",
          requirements: "Icon spawns in Chapter 8",
          guide: [
            "1. Find marker near ladder to Gambling Hall",
            "2. Go down ladder, speak to black leather jacket",
            "3. Fight CHAU KA LONG (Level 32)",
            " • Weak to Electric",
            " • Spinning weapon moves very damaging",
            " • Equip Stun/Bleed immunity recommended",
            "4. Unlocks his weapon shop"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 49,
          chapter: 8,
          name: "Repenting for the Past",
          location: "North Hamakita Park near water",
          reward: "Diamond Earrings, Munan Suzuki Dondoko Guest",
          requirements: "Must be daytime",
          guide: [
            "1. Approach gathered people at park",
            "2. Fight 5 Level 40 enemies",
            "3. Recommended to be higher level",
            "4. Unlocks Munan Suzuki as Dondoko guest"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          guide: [
            "1. Required by story",
            "2. Cannot be missed",
            "3. Part of main story progression"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 51,
          chapter: 8,
          name: "Friendship Has No Finish Line",
          location: "Children's Park northwest Kamurocho",
          reward: "Transcendent Insoles, Pocket Circuit Fighter Poundmate & Dondoko Guest",
          requirements: "Daytime in Kamurocho",
          guide: [
            "1. Approach kids at Children's Park",
            "2. Go to Public Park 3 in Tenkaichi Alley",
            "3. Defeat 2 Level 32 punks",
            "4. Unlocks multiple rewards"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          location: "East of Wild Jackson on Tenkaichi St.",
          reward: "Memoir completion",
          requirements: "None",
          guide: [
            "1. Speak to homeless man on ground",
            "2. Suggest 'Look for a hospital'",
            "3. Go west to marked elevator",
            "4. Enter elevator to complete"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 53,
          chapter: 8,
          name: "A Duel for the Ages",
          location: "Champion District southeast square",
          reward: "Golden Inro, Sotaro Komaki Poundmate",
          requirements: "Kiryu alone fight",
          guide: [
            "1. Find marker in southeast Champion District",
            "2. Defeat 3 Level 38 thugs",
            "3. Fight SOTARO KOMAKI (Level 38) alone:",
            " • Weak to Ice",
            " • Powers up at half health",
            " • Uses counter stance",
            "4. Tough fight even at recommended level"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          location: "Survive Bar",
          reward: "Bartender Poundmate & Dondoko Guest",
          requirements: "None",
          guide: [
            "1. Speak to Bartender at Survive Bar",
            "2. Conversation-based memoir",
            "3. Unlocks Bartender as Poundmate and Dondoko guest"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          location: "Bar District upper level 'Ginsharin'",
          reward: "Memoir progression",
          requirements: "Complete 'Will the Stars Shine Again?'",
          guide: [
            "1. Available after completing prerequisite memoir",
            "2. Go to upper level bars in Bar District",
            "3. Approach 'Ginsharin' bar",
            "4. Conversation-based progression"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 56,
          chapter: 12,
          name: "Thank You Very Michi!",
          location: "Story progression",
          reward: "Tiger Belt",
          requirements: "Unmissable",
          guide: [
            "1. Part of main story",
            "2. Cannot be missed",
            "3. Receive Tiger Belt upon completion"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 57,
          chapter: 12,
          name: "Will the Stars Shine Again?",
          location: "Story progression",
          reward: "Story progression",
          requirements: "Unmissable",
          guide: [
            "1. Part of main story",
            "2. Cannot be missed",
            "3. Required for other memoir unlocks"
          ].join("\n"),
          videoId: "",
        },
        {
          ...
          chapter: 12,
          name: "x4 Shine!",
          location: "Northeast of Millennium Tower",
          reward: "Ecstasy Rope, Yuki & Koyuki Poundmates & Dondoko Guests",
          requirements: "Complete 'Shooting for the Stars'",
          guide: [
            "1. Available after completing prerequisite",
            "2. Go to marked spot northeast of Millennium Tower",
            "3. Defeat 3 Level 40 enemies",
            "4. Unlocks multiple characters"
          ].join("\n"),
          videoId: "",
        },
        {
          index: 59,
          chapter: "Finale",
          name: "Legacies Live Forever",
          location: "Homeless camp in Yokohama",
          reward: "Final memoir completion",
          requirements: "Don't miss before ending",
          guide: [
            "1. Approach homeless camp chief in Yokohama",
            "2. Speak to him",
            "3. Final memoir completion",
            "4. Make sure not to miss before game end"
          ].join("\n"),
          videoId: "",
        }
      ],
